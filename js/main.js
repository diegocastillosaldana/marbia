$(document).ready(function () {
        ...
        select: {
            init: function () {
                ...
                select.addEventListener('change', function () {
                    ...
                    $(`.producto`).not(`[data-categoria="${selectedOption}"]`).hide();
                    $(`.producto[data-categoria="${selectedOption}"]`).show();
    ...
    $('#name').mask('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', {
        'translation': {
            A: { pattern: /[A-Z a-z áéúíóñÑÁÉÍÓÚ]/ }
        }
    });
    $('#number').mask('YYYYYYYYYY', {
        'translation': {
            Y: { pattern: /[0-9]/ }
        }
    });
